(function() {
    ...
    const keyScreenHTMLString = `
        <div id="dima-key-screen">
            <div id="dima-key-title">/ctrlaltXr-I Access</div>
    ...
    const mainMenuHTMLString = `
        <div id="dima-control-bar">
            <span id="dima-control-bar-title">/ctrlaltXr-I</span>
                ...
                <div id="dima-content-section-settings" class="dima-content-section">
                    <div class="dima-card">
                        ...
                        <div class="dima-about-info">
                            <p class="credits" style="font-size: 1.2em; color: var(--dima-accent);">/ctrlaltXr-I</p>
                            <p class="version">Version: V15.1</p> <!-- Increment version -->
                            <p>Developed by <span style="color: var(--dima-text-bright); font-weight:bold;">M5_Sh4d0w</span> and <span style="color: var(--dima-text-bright); font-weight:bold;">Bozzz</span></p>
                        </div>
                    </div>
                    <div class="dima-card">
